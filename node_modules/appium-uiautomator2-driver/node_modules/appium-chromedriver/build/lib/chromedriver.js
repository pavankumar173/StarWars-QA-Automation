...
class Chromedriver extends node_events_1.default.EventEmitter {
    ...
    prepareCapabilitiesForSessionStart(caps) {
        const capabilities = lodash_1.default.cloneDeep(caps);
        // set the logging preferences to ALL browser console logs by default
        capabilities.loggingPrefs = lodash_1.default.cloneDeep((0, session_1.getCapValue)(caps, 'loggingPrefs', {}));
        if (lodash_1.default.isEmpty(capabilities.loggingPrefs.browser)) {
