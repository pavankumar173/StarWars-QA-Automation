...
async function getCompatibleChromedriver() {
    ...
    if (!lodash_1.default.isEmpty(mapping)) {
        ctx.log.debug(`The most recent known Chrome version: ${lodash_1.default.values(mapping)[0]}`);
    }
...
async function mergeDiscoveredMappingGaps(ctx, cds, mapping) {
    ...
    ctx.log.info(`Found ${support_1.util.pluralize('Chromedriver', lodash_1.default.size(missingVersions), true)}, ` +
