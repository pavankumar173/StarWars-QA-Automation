...
async function startSession() {
    ...
    changeState.call(this, constants_1.CHROMEDRIVER_STATES.ONLINE);
    return lodash_1.default.has(response, 'capabilities') && response.capabilities
...
function changeState(state) {
    ...
    this.emit(constants_1.CHROMEDRIVER_EVENTS.CHANGED, { state });
}
